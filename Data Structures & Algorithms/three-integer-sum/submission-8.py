            ...
            if (index + 1) < len(s_nums):
                ...
                while left < right:
                    ...
                    if sum > 0:
                        ...
                        left += 1
                        #Tipped Start
                        #if current value at current index matches the previous value, iteratively move left index to right until no match
                        #"index" already stores that first value... why would you have "left" be the same value as "index"
