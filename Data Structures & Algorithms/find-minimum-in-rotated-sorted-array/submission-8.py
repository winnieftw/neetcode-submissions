...
class Solution:
    def findMin(self, nums: List[int]) -> int:
        ...
        while left <= right:
            ...
            #moved this here because need to set m_val first before we move index
            #my mistake was doing this comparison after i move the index
            if m_val < value:
                value = m_val
            ...
            else:   #added this here (from hint). If the condition above doesn't work at all, 
                    #break out otherwise infinite loop...
                break
            # if m_val < value:
            #     value = m_val
            # if m_val == value:
